import rtde_control
#from AR10_control.AR10_class import AR10
...
def main():
    ...
    path_pose3 = [-0.119, -0.601, 0.193, 1.70, 1.75, 1.27, velocity, acceleration, blend_3]
    path_pose4 = [-0.0896, -0.6246, 0.1907, 1.211, 1.312, 1.290, velocity, acceleration, blend_4]
