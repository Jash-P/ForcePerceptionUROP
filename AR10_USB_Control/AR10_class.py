...
nb: for forwarding serial ports to WSL
usbipd list
...
class AR10:
    def __init__(self):
        ...
        # configured to work with the default device 0x0 (or 0 in decimal).

        # Open the command port
        self.usb = serial.Serial('/dev/ttyACM0', baudrate=9600)
        # Command lead-in and device 0 are sent for each Pololu serial commands.
        self.pololu_command = chr(0xaa) + chr(0x0)
